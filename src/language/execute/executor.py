...
def execute(source_code: str, priority_code: str, buying_price_code: str, selling_price_code: str,
            ...
            max_holding_stock_quantity: int, cash: int, min_amount_per_stock=0):
    calculation_result = calculator.calculate(source_code, priority_code, buying_price_code, selling_price_code,
